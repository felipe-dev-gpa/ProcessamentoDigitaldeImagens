...
plt.subplot(2, 2, 1)
plt.title("Imagem Original 1lap ")
plt.imshow(imagem1_gray, cmap="gray")
plt.axis("off")


plt.subplot(2, 2, 2)
plt.title("Imagem Suavizada 1lap")
plt.imshow(imagem1_smoothed, cmap="gray")
plt.axis("off")


plt.subplot(2, 2, 3)
plt.title("Imagem Original 2lap ")
plt.imshow(imagem2_gray, cmap="gray")
plt.axis("off")


plt.subplot(2, 2, 4)
plt.title("Imagem Suavizada 2lap")
